...
3. Install [claude-notify](https://github.com/jak3676/claude-notify) for delivery scripts
4. Register scheduled tasks with your Claude Code scheduler

## Dependencies

- [claude-notify](https://github.com/jak3676/claude-notify) — delivery scripts (Discord, email, push, TTS)
